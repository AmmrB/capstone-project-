...
async function showWeatherDetails(city) {
    try {
        ...
        if (data && data.humidity !== undefined && data.windSpeed !== undefined) { // Ensure data and properties exist
            ...
            console.log("Weather data not available or incomplete for", city);
        }
    } catch (error) {
